...
//  MyLocations8
//
//  Created by Ed Katzman on 3/29/20.
...
class MapViewController: UIViewController {
    ...
    var managedObjectContext: NSManagedObjectContext! {
        didSet {
            NotificationCenter.default.addObserver(forName: Notification.Name.NSManagedObjectContextObjectsDidChange, object: managedObjectContext, queue: OperationQueue.main, using: { notification in
